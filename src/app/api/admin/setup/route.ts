...
const SITE_URL    = process.env.NEXT_PUBLIC_SITE_URL ?? 'https://www.aquaarcirrigation.com';
const BRAND_NAME  = process.env.NEXT_PUBLIC_BRAND_NAME ?? 'AquaArc Irrigation';
    ...
    <tr>
      <td align="center" style="padding:40px 16px;">
        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0"
          ...
          <!-- Accent bar -->
          <tr>
            <td style="height:4px;background:linear-gradient(90deg,#16def9 0%,#0284c7 100%);font-size:0;line-height:0;">&nbsp;</td>
          </tr>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
                ...
                <tr>
                  <td style="padding:14px 16px;font-size:13px;color:rgba(230,241,230,0.72);line-height:1.5;">
                    <strong style="color:#0284c7;">Security note —</strong>
