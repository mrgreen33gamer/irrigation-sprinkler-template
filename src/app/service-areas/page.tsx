...
// AquaArc Irrigation — Service Areas Page
'use client';
...
const SERVICE_AREAS = [
  {
    ...
    badge:       'Home Base',
    description: 'Our headquarters. Fastest response times, same-day service available 7 days a week. Full irrigation repair, installation, maintenance, and emergency service across all of Waco.',
  ...
  },
  {
    ...
    county:      'McLennan County',
    badge:       'Primary Area',
    description: 'Full irrigation coverage for Hewitt homes and businesses. Fast dispatch from our Waco base — typically under 45 minutes.',
  ...
  },
  {
    ...
    county:      'McLennan County',
    badge:       'Primary Area',
    description: "Serving Woodway's residential neighborhoods with the same flat-rate pricing and Green Lawn Guarantee as every other area we cover.",
    highlights:  ['Flat-rate pricing', 'Green Lawn Guarantee', 'All major brands'],
  },
  {
    city:        'Robinson',
    slug:        'robinson-tx',
    county:      'McLennan County',
    badge:       '',
    description: 'Reliable irrigation service for Robinson residents. We cover all makes and models — Carrier, Trane, Lennox, Rheem, Goodman, and more.',
    highlights:  ['All brands serviced', 'licensed irrigator techs', 'No contracts'],
  },
  {
    city:        'China Spring',
    ...
    county:      'McLennan County',
    badge:       '',
    description: 'Rural and residential irrigation service for the China Spring area. We make the drive — flat-rate pricing applies just the same.',
  ...
  },
  {
    ...
    county:      'Bell County',
    badge:       '',
    description: 'irrigation repair, installation, and maintenance for Killeen and Fort Cavazos area homes and businesses. Military-friendly scheduling.',
  ...
  },
  {
    ...
    county:      'Bell County',
    badge:       '',
    description: 'Full-service irrigation coverage for Temple. Scott & White medical district and surrounding neighborhoods served. All systems, all brands.',
  ...
  },
  {
    ...
    badge:       '',
    description: 'Extending our coverage into Bosque County — Valley Mills residents get the same certified technicians, flat-rate pricing, and Green Lawn Guarantee.',
    highlights:  ['Bosque County coverage', 'Certified techs', 'Green Lawn Guarantee'],
  },
  {
    city:        'Hillsboro',
    slug:        'hillsboro-tx',
    county:      'Hill County',
    badge:       '',
    description: 'irrigation service for Hillsboro and Hill County. When your AC goes down in the summer heat, we\'ll get there fast.',
...
const faq = [
  ...
  {
    question: 'Do you work on commercial irrigation in all areas?',
    answer: 'Yes — light commercial irrigation for restaurants, offices, retail spaces, and small warehouses is within scope across all our coverage areas. Call to discuss your specific system and location.',
  },
  {
    ...
    <main className={styles.page}>
        ...
        <div className={styles.heroInner}>
          ...
          >
            <div className={styles.heroBadge}>
              ...
              Central Texas irrigation — Since 2012
            </div>
            ...
            <p className={styles.heroSub}>
              Based in Waco, serving all of Central Texas. Flat-rate pricing, licensed irrigator techs, and a Green Lawn Guarantee — no matter where you are.
            </p>
            <div className={styles.heroActions}>
              <a href="tel:+12549902020" className={styles.heroCTAPrimary}>
        ...
        <div className={styles.areasSectionInner}>
          <div className={styles.sectionHeader}>
            ...
            <p className={styles.sectionSub}>
              Click any city to see local service details, common irrigation issues in your area, and what to expect from our team.
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className={styles.areaFooter}>
                    <a href="tel:+12549902020" className={styles.areaCallBtn}>
      ...
      <section className={styles.unlisted}>
        <div className={styles.unlistedInner}>
          ...
          <a href="tel:+12549902020" className={styles.unlistedCTA}>
            Call (254) 990-2020
          </a>
        </div>
      </section>
      ...
      <CTABanner
        ...
        subline="Same-day service available across Central Texas. Flat-rate pricing, Green Lawn Guarantee, no contracts ever."
