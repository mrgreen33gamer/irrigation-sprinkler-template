...
export default function NearbyAreasHero({
  ...
  const displayHeadline = headline ?? `irrigation Service in ${cityName}, TX`;
  const displayDesc     = description ??
    `AquaArc Irrigation provides fast, reliable sprinkler and drip irrigation service to ${cityName} and all surrounding communities. Licensed technicians, flat-rate pricing, Green Lawn Guarantee on every job.`;
    ...
    <section className={styles.section}>
      ...
      <div className={styles.container}>
        ...
        >
          ...
          <a href="tel:+12549902020" className={styles.phoneBtn}>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
