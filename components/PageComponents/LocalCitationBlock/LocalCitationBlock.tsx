...
const LocalCitationBlock: React.FC<LocalCitationBlockProps> = ({
  businessName  = 'AquaArc Irrigation',
  address       = 'Waco, TX 76701',
  phone         = '(254) 990-2020',
  email         = 'service@aquaarcirrigation.com',
  googleMapsUrl = 'https://maps.google.com/?q=AquaArc+Irrigation+Waco+TX',
  hours         = DEFAULT_HOURS,
  cityName      = 'Waco',
}) => {
  return (
    <section
      ...
      itemScope
      itemType="https://schema.org/irrigationBusiness"
    >
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Based in {cityName}, TX — serving all of Central Texas with licensed irrigation technicians.
          </p>
        </div>
