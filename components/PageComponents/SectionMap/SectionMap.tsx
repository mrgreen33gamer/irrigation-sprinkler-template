  ...
  const initMap = () => {
    ...
    currentMap.on('load', () => {
      ...
      new mapboxgl.Marker({ element: hqEl, anchor: 'center' })
        ...
        .setPopup(new mapboxgl.Popup().setHTML('<strong>AquaArc Irrigation</strong><br>900 S University Parks Dr, Waco, TX 76706'))
        .addTo(currentMap);
  ...
  return (
    <section ref={sectionRef} className={styles.mapSection}>
      ...
      <div className={styles.mapLegend}>
        <div><span className={styles.hqDot} /> AquaArc Irrigation – Waco</div>
